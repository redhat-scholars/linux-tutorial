...
TIP: During the install process you already registered your RHEL system or are using a pre-registered lab, but you may still want to learn how to do so from the CLI.
